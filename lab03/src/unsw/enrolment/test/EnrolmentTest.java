...
public class EnrolmentTest {
    ...
    public static void main(String[] args) {
        ...
        Lecture lecture1511 = new Lecture(comp1511Offering, "101", DayOfWeek.TUESDAY, LocalTime.of(12, 0),LocalTime.of(14, 0), "Edward");
        Lecture lecture1531 = new Lecture(comp1531Offering, "102", DayOfWeek.MONDAY, LocalTime.of(9, 0),LocalTime.of(11, 0), "David");
        Lecture lecture2521 = new Lecture(comp2521Offering, "103", DayOfWeek.FRIDAY, LocalTime.of(15, 0),LocalTime.of(17, 0), "Kayle");

        Tutorial tute1531 = new Tutorial(comp1531Offering, "202", DayOfWeek.WEDNESDAY, LocalTime.of(18, 0), LocalTime.of(19,0), "Lang");
