...
public class Grade {
    ...
    private Marking strategy;
    private ArrayList<GradeObserver> subscribers;
	private GradeObserver gradeObserver;
	...
	public Grade addComponent(Grade grade) {
		...
		registerObserverSubscription(grade);
	...
	private void registerObserverSubscription(Grade grade) {
		if (gradeObserver == null) {
			this.gradeObserver = (a, data) -> {
				this.notifySubscribers(data);
			};
		}

		grade.subscribe(gradeObserver);
	}
